...
![Screenshot of the AQI Prediction Panel](assets\aqi_prediction.png)

### 3. 24-Hour Forecast

A visualization showing the predicted hourly AQI trend for the next 24 hours.

![Screenshot of the 24-Hour Forecast](assets\24_hour_forecast.png)

### 4. 7-Day Forecast

A visualization showing the predicted daily AQI trend for the next 7 days.

![Screenshot of the 7-Day Forecast](assets\7_day_forecast.png)
...
![Screenshot of the Pollutant Analysis](assets\pollutant_analysis.png)

### 6. Multi-Center Comparison

A view that compares the AQI and pollutant levels across different monitoring centers in Delhi.

![Screenshot of the Multi-Center Comparison](assets\multi_center_comparison.png)
